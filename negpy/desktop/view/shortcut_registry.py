...
REGISTRY: dict[str, ShortcutEntry] = {
    ...
    "tab_tone": ShortcutEntry("Ctrl+2", "Tone tab", "Tabs"),
    "tab_color": ShortcutEntry("Ctrl+3", "Color tab", "Tabs"),
    "tab_finish": ShortcutEntry("Ctrl+4", "Finish tab", "Tabs"),
    "tab_export": ShortcutEntry("Ctrl+5", "Export tab", "Tabs"),
    "tab_metadata": ShortcutEntry("Ctrl+6", "Metadata tab", "Tabs"),
    "tab_history": ShortcutEntry("Ctrl+7", "History tab", "Tabs"),
    "tab_scan": ShortcutEntry("Ctrl+8", "Scan tab", "Tabs"),
